...
export const courseCategories = ["development", "designing"] as const;

export type Level = (typeof courseLevels)[number];
...
export const courses: Course[] = [
    ...
    longDescription: (
      <>
        <p>
          ...
          This course is designed to teach you the essentials of HTML, CSS, and
        ...
        <p>
          ...
          create interactive and visually appealing web pages. The course also
        ...
        <p>
          Build a portfolio-ready project by the end of the course to showcase
  ...
  },
  {
    ...
    longDescription: (
      <>
        ...
        <p>
          ...
          Python&apos;s versatile libraries. The course includes practical
        ...
        <p>
          The course also dives into using third-party libraries, enabling you
          to extend Python&apos;s functionality for various use cases. By the
          end, you&apos;ll be equipped with the skills needed to start building
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes, you'll build small Python scripts during the course.",
      },
    ],
    price: 39.99,
    language: "English",
  ...
  },
  {
    ...
    longDescription: (
      <>
        <p>
          ...
          this hands-on workshop. Perfect for beginners, this course explores
    ...
    faqs: [
      ...
      {
        question: "Can I use this course to create a portfolio?",
    ...
    longDescription: (
      <>
        <p>
          ...
          This course introduces the fundamental principles of user interface
          and user experience design, equipping you with skills to create
        ...
        <p>
          ...
          The course also delves into responsive and adaptive design, enabling
          you to create interfaces optimized for various devices and screen
          sizes.
        </p>
        <p>
        ...
        <p>
          With Nexorith as the foundation, this course introduces advanced
          topics like integrating AI into UX research and incorporating UX
          practices into agile workflows. These skills will prepare you to
          tackle the challenges of the ever-evolving design landscape.
        </p>
        <p>
          By the end of the course, you&apos;ll have the expertise to design
        ...
        <p>
          ...
          professional seeking to enhance your skills, this course offers
